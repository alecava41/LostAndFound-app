...
/// @nodoc
abstract class _$$_SortParameterChangedCopyWith<$Res> {
  factory _$$_SortParameterChangedCopyWith(_$_SortParameterChanged value,
          $Res Function(_$_SortParameterChanged) then) =
      __$$_SortParameterChangedCopyWithImpl<$Res>;
  @useResult
  $Res call({ResultOrder order});
}

/// @nodoc
class __$$_SortParameterChangedCopyWithImpl<$Res>
    extends _$SearchEventCopyWithImpl<$Res, _$_SortParameterChanged>
    implements _$$_SortParameterChangedCopyWith<$Res> {
  __$$_SortParameterChangedCopyWithImpl(_$_SortParameterChanged _value,
      $Res Function(_$_SortParameterChanged) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_SortParameterChanged(
      null == order
          ? _value.order
...
class _$_SortParameterChanged implements _SortParameterChanged {
  const _$_SortParameterChanged(this.order);
  ...
  @override
  String toString() {
    return 'SearchEvent.sortParameterChanged(order: $order)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_SortParameterChanged &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_SortParameterChangedCopyWith<_$_SortParameterChanged> get copyWith =>
      __$$_SortParameterChangedCopyWithImpl<_$_SortParameterChanged>(
          this, _$identity);
...
abstract class _SortParameterChanged implements SearchEvent {
  const factory _SortParameterChanged(final ResultOrder order) =
      _$_SortParameterChanged;
...
class __$$_RestoreInitialCopyWithImpl<$Res>
    extends _$SearchEventCopyWithImpl<$Res, _$_RestoreInitial>
...
class _$_RestoreInitial implements _RestoreInitial {
  ...
  @override
  String toString() {
    return 'SearchEvent.restoreInitial()';
  }
...
abstract class _RestoreInitial implements SearchEvent {
