...
class InsertItemScreen extends StatelessWidget {
  ...
  void onTapGallery(BuildContext ctx) {
    Navigator.pop(ctx);
    getImage(ImageSource.gallery, (image, path) => ctx.read<InsertItemBloc>().add(InsertItemEvent.imageSelected(image!)));
  }

  void onTapCamera(BuildContext ctx) {
    Navigator.pop(ctx);
    getImage(ImageSource.camera, (image, path) => ctx.read<InsertItemBloc>().add(InsertItemEvent.imageSelected(image!)));
  }
                          ...
                          child: Column(children: [
                            ...
                            PersonalizedFormWithTextInsertion(
                              ...
                              errorText: state.title.value.fold(
                                  ...
                                  (r) => null),
                              onTextChanged: (input) =>
                                  ctx.read<InsertItemBloc>().add(InsertItemEvent.titleChanged(input)),
