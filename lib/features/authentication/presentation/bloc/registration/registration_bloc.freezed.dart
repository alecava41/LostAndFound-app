...
mixin _$RegistrationState {
  ...
  Either<RegistrationFailure, Success>? get registrationFailureOrSuccess =>
      throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      registrationFailureOrSuccess: freezed == registrationFailureOrSuccess
          ...
          : registrationFailureOrSuccess // ignore: cast_nullable_to_non_nullable
              as Either<RegistrationFailure, Success>?,
    ) as $Val);
  }
}
...
class _$_RegistrationState implements _RegistrationState {
  ...
  @override
  final Either<RegistrationFailure, Success>? registrationFailureOrSuccess;
...
abstract class _RegistrationState implements RegistrationState {
  const factory _RegistrationState(
      ...
      final bool obscurePassword,
      final bool obscureConfirmPassword,
      final Either<RegistrationFailure, Success>?
