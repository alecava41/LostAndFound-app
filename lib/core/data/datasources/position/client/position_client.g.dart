...
class _PositionClient implements PositionClient {
  _PositionClient(
    this._dio, {
    this.baseUrl,
  }) {
    baseUrl ??= 'http://13.53.123.54:5000/api/position';
  }
  ...
  @override
  Future<PositionDto> getPositionFromAddress(String address) async {
    const _extra = <String, dynamic>{};
